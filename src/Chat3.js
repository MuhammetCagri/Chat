...
class Chat3 extends Component {
  ...
  componentDidMount = () => {
    //Local stograden
    const accessToken= 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1bmlxdWVfbmFtZSI6InV1dUB1dXUuY29tIiwic3ViIjoiYXV0aG9yaXphdGlvbiIsImp0aSI6IjM3IiwiYXVkIjpbIkF1ZGllbmNlIiwiYXVkaWVuY2UiXSwiZXhwIjoxNzEzMjcyOTY2LCJpc3MiOiJhdXRoZW50aWNhdGlvbiJ9.ao40Nl7acZXXTMx7dZoGEqPIIpVVXGm_iuqxiLrGIX4'
    ...
    this.setState({ hubConnection }, () => {
      ...
      this.state.hubConnection.on('ReceiveRefreshChat', ( data) => {
        console.log(data);
      });
